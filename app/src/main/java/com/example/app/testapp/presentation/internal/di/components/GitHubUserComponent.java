 ...
 */
@PerFragment
@Component(dependencies = RepositoryComponent.class, modules = {GitHubUserModule.class})
public interface GitHubUserComponent {
  void inject(UserDataFragment userListFragment);
  void inject(SearchFragment userDetailsFragment);
}
